...
> [Documentation](/docs/README.md) → [Architecture](/docs/ARCHITECTURE.md) → The hub
...
| Integrations (MCP) | Generic OAuth2/PKCE-authenticated MCP server registration. Configuration only today — see the honest note in [ARCHITECTURE.md §2](/docs/ARCHITECTURE.md#_2-connecting-to-your-data-tools-and-connectors) on why an enabled integration isn't yet callable by an investigation. |
...
- What external systems it proxies to: [Connectors](/docs/architecture/connectors-web.md), [CRM connector](/docs/architecture/connectors-crm-dynamics-ax.md)
