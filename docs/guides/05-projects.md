...
| Integrations | Which of the org's registered tool integrations ([4](04-connectors.md)) this project enables. As noted there, these aren't yet reachable by an investigation's reasoning step — that wiring is on the roadmap. |
